...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $contact->user_id = getCurrentUserId();
    ...
    if (empty($error_messages)) {
        if ($contact->create()) {
            ...
            $error_messages[] = 'Failed to create contact. Please try again.';
        }
    }
}
?>
            ...
            <div class="col-md-8 col-lg-6">
                <div class="form-container">
                    <div class="text-center mb-4">
                        ...
                        <p class="text-muted">Fill in the contact information below</p>
                    </div>
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control" id="notes" name="notes" rows="4" 
                                      placeholder="Add any additional notes about this contact"><?php echo htmlspecialchars($_POST['notes'] ?? ''); ?></textarea>
                        </div>
